...
def createPattern(motherData, pat_x_axis, result_pat_x_axis) :
    global PAT_Y_AXIS
    global RESULT_PAT_Y_AXIS
    ...
    for i in range(0, len(motherData) - max(pat_x_axis, result_pat_x_axis), 1) :
        patMatrix = makePattern(motherData, i, pat_x_axis, PAT_Y_AXIS)

        resultPatMatrix = makeResultPattern(motherData,
                                            i,
                                            pat_x_axis,
                                            PAT_Y_AXIS,
                                            result_pat_x_axis,
        ...
        if resultPatMatrix is None :
            continue

        registerPatternGroup(patMatrix, resultPatMatrix)
